...
###ajjc import alpaca_trade_api.rest as apca
...
### ajjc All real time clock tests failing as of 2019-10-10
class _TestRealtimeClock(TestCase):
    @classmethod
    def setUpClass(cls):
...
### ajjc Commented out AlgoState in zipline-live as feature is not robust enough for me.(e.g. doesnt cover classes)
### Hence, skip the tests for that feature.
class _TestPersistence(WithSimParams,
                      WithDataPortal,
                      ZiplineTestCase):
